...
def process_move(p, b): 
    ...
    This will perform all of the steps involved in processing a single move by player p on board b'''
...
class RandomPlayer(Player):
    def next_move(self, b):
        '''this version of next_move will choose at random one of the columns that are open for checker to be placed into'''
        column = []
